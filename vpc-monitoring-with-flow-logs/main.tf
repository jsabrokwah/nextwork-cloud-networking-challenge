...
resource "aws_iam_policy" "NextWorkVPCFlowLogsPolicy" {
  name        = "NextWorkVPCFlowLogsPolicy"
...
resource "aws_iam_role" "NextWorkVPCFlowLogsRole" {
  name = "NextWorkVPCFlowLogsRole"
...
resource "aws_iam_role_policy_attachment" "NextWorkVPCFlowLogsRole_policy" {
  role       = aws_iam_role.NextWorkVPCFlowLogsRole.name
  policy_arn = aws_iam_policy.NextWorkVPCFlowLogsPolicy.arn
}

# Create CloudWatch Log Group for VPC Flow Logs
resource "aws_cloudwatch_log_group" "NextWorkVPCFlowLogsGroup" {
...
# Create VPC Flow Log for Public Subnet 1
resource "aws_flow_log" "NextWorkVPCFlowLog" {
  log_destination      = aws_cloudwatch_log_group.NextWorkVPCFlowLogsGroup.arn
  iam_role_arn         = aws_iam_role.NextWorkVPCFlowLogsRole.arn
  traffic_type         = "ALL"
